...
In order to get an overview of the tables present in a *regulonData* object, we can use the function `list_datasets()`. This function will output all the available tables that can be used to design queries. 
...
ecoli_regulondb <- 
  build_regulondb(
    ...
    organism="E.coli", database_version="1", genome_version="1" )
