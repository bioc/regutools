...
outdir <- 'regutools_files'
pkgname <- 'regutools'


meta <- data.frame(
    Title = 'RegulonDB SQLite database version v10.6.2_DM for the regutools Bioconductor package',
    Description = "An SQLite version of the RegulonDB database specifically tailored for the regutools Bioconductor package.",
    BiocVersion = "3.10",
    Genome = NA,
    SourceType = "MySQL",
    SourceUrl = 'https://bioconductor.org/packages/regutools',
    SourceVersion = "Feb 25 2020",
    Species = NA,
    TaxonomyId = NA,
    Coordinate_1_based = TRUE,
    DataProvider = "RegulonDB",
    Maintainer = "Leonardo Collado-Torres <lcolladotor@gmail.com>",
    RDataClass = 'SQLite',
    DispatchClass = 'SQLiteFile',
    RDataPath = file.path(pkgname, outdir, 'regulon_sqlite3_v10.6.2_DM.db'),
    Tags = 'regutools;RegulonDB;v10.6.2_DM',
    row.names = NULL,
...
write.csv(
    meta,
    file = here::here('inst', 'extdata', 'metadata_regutools.csv'),
    row.names = FALSE
)
