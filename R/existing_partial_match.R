...
#' The output is used in \code{\link{ExistingIntervals}} and \code{\link{NonExistingIntervals}}.
...
#' @return A sql logical condition to query the dataset
#' @examples
#' existing_partial_match(filters = list(name=c("ara"),
#'                                     strand=c("forward"),
#'                                     posright=c("2000","40000")),
#'                      partialmatch = "name",
#'                      operator = "AND")
#' @export
existing_partial_match<-function(filters, partialmatch, operator){
